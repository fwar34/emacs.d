...
(use-package meow
  ...
  (defun meow-setup ()
    ...
    (meow-normal-define-key
     ...
     '("; fa" . (lambda () (interactive) (consult-ripgrep (my-project-root))))
     ...
     '("; fw" . (lambda () (interactive) (my-search-whole-word 'consult-ripgrep)))
     '("; fs" . (lambda () (interactive) (my-search-forward-word 'consult-ripgrep)))
     '("; ls" . (lambda () (interactive) (consult-line (my-word-at-point))))
     '("; lw" . (lambda () (interactive) (consult-line (my-word-at-point t))))
     '("; ee" . save-buffer)
     '("; md" . mark-defun)
