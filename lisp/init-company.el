...
(defun my-evil-insert-state-entry-hook-setup ()
  "Enable company mode in evil-state-entry-hook."
...
In that case, insert the number."
  ...
  (use-package company-c-headers
    :config
    (add-to-list 'company-backends 'company-c-headers)))
(add-hook 'evil-insert-state-entry-hook #'my-evil-insert-state-entry-hook-setup)
